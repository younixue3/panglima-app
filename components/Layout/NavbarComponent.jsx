...
export default class NavbarComponent extends Component {
    ...
    render() {
        return (
            <nav className={"bg-white sm:bg-transparent"}>
                <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                    <div className="relative flex h-16 items-center justify-between">
                        ...
                        <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-between">
                            <Link href={''}
                                  className="flex flex-shrink-0 items-center font-bold text-2xl text-yellow-400">
                                <Image width={125} height={100} src={'/logo.png'} alt={'logo panglima'}/>
                            </Link>
                ...
                <div
                    className={'sm:hidden absolute bg-white w-full transition-all ease-in-out overflow-hidden ' + (this.state.toggle ? 'h-60' : 'h-0')}
                    id="mobile-menu">
                    <div className="space-y-1 px-2 pb-3 pt-2">
                        <a href="#"
                           className="text-gray-300 hover:bg-primary  block rounded-md px-3 py-2 text-base font-medium"
                           aria-current="page">Dashboard</a>
                        <a href="#"
                           className="text-gray-300 hover:bg-primary block rounded-md px-3 py-2 text-base font-medium">Team</a>
                        <a href="#"
                           className="text-gray-300 hover:bg-primary block rounded-md px-3 py-2 text-base font-medium">Projects</a>
                        <a href="#"
                           className="text-gray-300 hover:bg-primary block rounded-md px-3 py-2 text-base font-medium">Calendar</a>
